...
#ifndef __DC_BACKOFF_H__
#define __DC_BACKOFF_H__
...
public:
  ...
  DCBackoff (void);
  DCBackoff (Time slotTime, uint32_t minSlots, uint32_t maxSlots, uint32_t ceiling, uint32_t maxRetries);
