...
#ifndef __DC_POINT_NET_DEVICE_H__
#define __DC_POINT_NET_DEVICE_H__
...
class DCCsmaChannel;
class ErrorModel;
class DCPointForward;

#define __DEBUG_POINT_DEVICE__

/** 
 * \defgroup csma DCCsmaNetDevice
 *
 ...
 */
class DCCsmaNetDevice : public DCPointNetDeviceBase 
{
public:
    ...
    */
    virtual void SetBackoffParams (Time slotTime, uint32_t minSlots, uint32_t maxSlots, 
    ...
    */
    virtual bool Attach (Ptr<DCPointChannelBase> ch);

    /**
    * Attach a queue to the CsmaNetDevice.
    *
    * The DCCsmaNetDevice "owns" a queue.  This queue may be set by higher
    ...
    */
    void Receive (Ptr<Packet> p, Ptr<DCCsmaNetDevice> sender);
    ...
    *
    */
    void SetEncapsulationMode (DCCsmaNetDevice::EncapsulationMode mode);
    ...
    */
    DCCsmaNetDevice::EncapsulationMode  GetEncapsulationMode (void);


    // 
    typedef Callback<bool, Ptr<const NetDevice>, Ptr<const Queue>, Ptr<const Packet> > TxPreEnqueueCallback;
    typedef Callback<void, Ptr<const Packet> > TxPostEnqueueCallback;
    typedef Callback<void, Ptr<const Packet> > TxSentSucessCallback;
    typedef Callback<void, Ptr<const Packet> > TxDropCallback;
    typedef Callback<void, Ptr<const Packet> > RxDropCallback;

    virtual void SetTxPreEnqueueCallback (TxPreEnqueueCallback cb);
    virtual void SetTxPostEnqueueCallback (TxPostEnqueueCallback cb);
    virtual void SetTxSentSucessCallback (TxSentSucessCallback cb);
    virtual void SetTxDropCallback (TxDropCallback cb);
    virtual void SetRxDropCallback (RxDropCallback cb);

    virtual void SetForward (Ptr<DCPointForward> forward);
...
protected:
    ...
    */
    virtual void AddHeader (Ptr<Packet> p, Mac48Address source, Mac48Address dest, uint16_t protocolNumber);
...
private:
    ...
    */
    DCCsmaNetDevice &operator = (const DCCsmaNetDevice &o);
    ...
    * \param o object to copy
    */
    DCCsmaNetDevice (const DCCsmaNetDevice &o);
...
protected:
    ...
    */
    virtual void TransmitCompleteEvent (void);
    ...
    * \see TransmitStart ()
    */
    virtual void TransmitReadyEvent (void);
    ...
    */
    virtual void TransmitAbort (void);
    ...
    */
    ...
    struct PktProcHook 
    {
        TxPreEnqueueCallback txPreEnqueue;
        TxPostEnqueueCallback txPostEnqueue;
        TxSentSucessCallback txSentSucess;
        TxDropCallback txDrop;
        RxDropCallback rxDrop;
    };
    PktProcHook m_pktProcHook;

    bool m_enableArp;
    Ptr<DCPointForward> m_forward;
...
#endif /* __DC_POINT_NET_DEVICE_H__ */
