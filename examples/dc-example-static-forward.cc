...
main(int argc, char *argv[])
{
    ...
    DCHelper helper;
    helper.SetBridgeForward("ns3::DCBridgeStaticForward");
    helper.SetPointForward("ns3::DCPointStaticForward");
    helper.SetFactoryAttribute("bridge","EnableArp",BooleanValue(false));
    helper.SetFactoryAttribute("point","EnableArp",BooleanValue(false));
    ...
    helper.SetLinkAttribute ("DataRate",DataRateValue(DataRate("10Gbps")));
    helper.SetLinkAttribute ("Delay",TimeValue(Time("10ms")));
    //helper.SetBridgeForward("ns3::DCLearnForward");
    //helper.SetBridgePktPreProcess("ns3::DCBridgeCallback");
    //helper.SetPortPktProcess("ns3::DCPortCallback");
    ...
    random.CDF(0.0,0.0);
    random.CDF(((float)hosts.GetN()/(float)2),0.5);
    random.CDF(hosts.GetN(),1.0);
